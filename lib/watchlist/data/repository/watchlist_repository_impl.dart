...
import 'package:movie_app/watchlist/data/model/watchlist_item_model.dart';
...
class WatchListRepositoryImpl extends WatchlistRepository {
  ...
  Future<Either<Failure, int>> addWatchListItem(Media media) async {
    try {
      int id = await _baseWatchlistLocalDataSource.addWatchListItem(WatchlistItemModel.fromEntity(media),);
      return Right(id);
